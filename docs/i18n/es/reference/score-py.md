...
Script de scoring usado para servir predicciones desde el endpoint desplegado en Azure ML. Implementa `init()` para cargar el modelo registrado y `run()` para validar las entradas y devolver predicciones.

[⬇ Descargar score.py](../assets/files/score.py){ .md-button .md-button--primary download="score.py" }
